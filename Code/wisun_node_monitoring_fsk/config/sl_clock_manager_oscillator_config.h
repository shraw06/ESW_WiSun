...
#define SL_CLOCK_MANAGER_HFXO_CTUNE    93
#endif
...
// <cmuHFRCODPLLFreq_100M0Hz=> 100 MHz
...
// <o SL_CLOCK_MANAGER_RFFPLL_BAND> Target RF band (with 39MHz crystal)
...
// <e SL_CLOCK_MANAGER_RFFPLL_CUSTOM_BAND> Use custom band (overrides Target RF band)
// <d> 0
#ifndef SL_CLOCK_MANAGER_RFFPLL_CUSTOM_BAND
#define SL_CLOCK_MANAGER_RFFPLL_CUSTOM_BAND    0
#endif

// <o SL_CLOCK_MANAGER_RFFPLL_FREQ> Digital host target frequency in Hz
...
// <o SL_CLOCK_MANAGER_RFFPLL_DIV_Y> Digital host clock output divider ratio (DIVY)
// <8-31:1>
...
// <o SL_CLOCK_MANAGER_RFFPLL_DIV_X> Radio output divider ratio (DIVX)
// <4-15:1>
...
// <o SL_CLOCK_MANAGER_RFFPLL_DIV_N> PLL feedback divider ratio (DIVN)
// <32-127:1>
