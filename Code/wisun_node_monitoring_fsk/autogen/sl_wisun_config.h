...
//! Wi-SUN network name
#define WISUN_CONFIG_NETWORK_NAME               "SCRC_FAN11_OFDM"
...
#define WISUN_CONFIG_REGULATORY_DOMAIN          5

//! Wi-SUN default PHY - Channel Plan ID
#define WISUN_CONFIG_CHANNEL_PLAN_ID            39

//! Wi-SUN default PHY - PHY Mode ID
#define WISUN_CONFIG_PHY_MODE_ID                1
