/***************************************************************************//**
 * @file sl_wisun_app_core_config.h
 * @brief Wi-SUN Application core configuration
 *******************************************************************************
 * # License
...
/**************************************************************************//**
 * @defgroup SL_WISUN_APP_CORE_CONFIG Configurations
...
#define SL_WISUN_APP_CORE_REGULATION_NONE                      0U ///< Regulation None

// corresponds to SL_WISUN_REGULATION_ARIB
#define SL_WISUN_APP_CORE_REGULATION_ARIB                      1U ///< Regulation ARIB

// corresponds to SL_WISUN_REGULATION_WPC
#define SL_WISUN_APP_CORE_REGULATION_WPC                       2U ///< Regulation WPC
...
#define SL_WISUN_APP_CORE_REGULATION                            SL_WISUN_APP_CORE_REGULATION_NONE ///< Regulation
// </h> Regulation
...
#define SL_WISUN_APP_CORE_TX_BUDGET                             720000UL ///< Wi-SUN regulation transmission budget
// </h> Wi-SUN regulation transmission budget
...
// <i> Default: 85 %
#define SL_WISUN_APP_CORE_DEFAULT_REGULATION_WARNING_THRESHOLD  85U ///< Transmission duration level warning threshold
...
// <i> Default: 95 %
#define SL_WISUN_APP_CORE_DEFAULT_REGULATION_ALERT_THRESHOLD    95U ///< Transmission duration level alert threshold
// </h> Wi-SUN regulation warning and alert thresholds
...
// <i> Default: 256 word
#define SL_WISUN_APP_CORE_MAIN_STACK_SIZE_WORD                  256UL ///< Recommended Application thread stack size

// <o SL_WISUN_APP_CORE_THREAD_LP_DISPATCH_MS> Thread dispatch delay for low power mode
// <i> Default: 1000
#define SL_WISUN_APP_CORE_THREAD_LP_DISPATCH_MS                 1000UL ///< Thread dispatch delay for low power mode
...
#endif // SL_WISUN_APP_CORE_CONFIG_H
