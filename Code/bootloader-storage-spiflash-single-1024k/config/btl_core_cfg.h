/***************************************************************************//**
 * @file
 * @brief Configuration header of Bootloader Core for Series 2 devices
 *******************************************************************************
 * # License
...
// <q BOOTLOADER_USE_SYMMETRIC_KEY_FROM_SE_STORAGE> Use symmetric key stored in Secure Element storage
// <i> Default: 0
// <i> Use the symmetric key stored in Secure Element storage for encryption and decryption.
...
// APPLICATION_VERIFICATION_SKIP_EM4_RST Skip verification of application on EM4 reset
// Default: 0
